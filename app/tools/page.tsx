    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 pt-16">
      ...
      <div className="p-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">精选高效工具，助力您的工作和生活</p>
        </div>
            ...
            >
              <div className="text-center">
                ...
                <div className="flex justify-center space-x-2 text-xs text-gray-500 mb-4">
                  <span className={`px-2 py-1 ${tool.categoryColor} rounded-lg`}>
                    {tool.category}
                  </span>
                ...
                <div className="flex justify-center space-x-1 mb-4">
                  ...
                  <span className="text-xs text-gray-500 ml-2">{tool.rating}</span>
                </div>
              </div>
            </div>
          ))}
