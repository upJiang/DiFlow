...
export default function HomePage() {
  ...
  const [streamingMessage, setStreamingMessage] = useState<StreamingMessage>({ content: '' })
    ...
    <div className="h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col">
          {/* 对话区域 */}
          <div ref={chatContainerRef} className="flex-1 overflow-auto p-6 pt-20">
              ...
              {messages.length === 0 && !streamingMessage.content && (
                <div className="flex flex-col items-center justify-center h-full text-center py-16">
                  ...
                  <div className="text-lg text-gray-600 mb-12 max-w-2xl leading-relaxed">
                    ...
                    <p className="mb-4">我是你的专属AI小助手，拥有超强的学习能力和创造力！</p>
                    <p>✨ 无论是编程、写作、分析数据，还是天马行空的创意，我都能陪你一起探索！</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                    ...
                    >
                      ...
                      <div className="font-bold text-gray-900 text-lg mb-2">SEO优化大师</div>
                      <div className="text-sm text-gray-600">让你的网站在搜索引擎中闪闪发光！</div>
                    </button>
                    
                    <button 
                      onClick={() => sendExampleMessage('帮我写一个Python数据分析脚本')}
                    ...
                    >
                      <div className="text-3xl mb-4 group-hover:animate-bounce">🐍</div>
                      <div className="font-bold text-gray-900 text-lg mb-2">编程魔法师</div>
                      <div className="text-sm text-gray-600">用代码创造无限可能，让数据说话！</div>
                    </button>
                    
                    <button 
                      onClick={() => sendExampleMessage('解释一下机器学习的基本概念')}
                    ...
                    >
                      <div className="text-3xl mb-4 group-hover:animate-bounce">🧠</div>
                      <div className="font-bold text-gray-900 text-lg mb-2">知识探索家</div>
                      <div className="text-sm text-gray-600">和我一起遨游知识的海洋吧！</div>
                    </button>
                    
                    <button 
                      onClick={() => sendExampleMessage('创建一个项目管理工作流')}
                    ...
                    >
                      <div className="text-3xl mb-4 group-hover:animate-bounce">🚀</div>
                      <div className="font-bold text-gray-900 text-lg mb-2">效率提升器</div>
                      <div className="text-sm text-gray-600">让工作变得井井有条，事半功倍！</div>
                    </button>
                  </div>
                </div>
              )}
                      ...
                      <div className="flex-1 max-w-3xl">
                        <div className="p-4 bg-white/70 backdrop-blur-sm border border-gray-200/50 rounded-2xl">
                          <div className="whitespace-pre-wrap break-words">
                            {streamingMessage.content}<span className="animate-pulse">|</span>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <form onSubmit={(e) => { e.preventDefault(); sendMessage(); }} className="flex items-end space-x-4">
            ...
            <button
              type="submit"
              disabled={!inputMessage.trim() || loading || !!streamingMessage.content}
