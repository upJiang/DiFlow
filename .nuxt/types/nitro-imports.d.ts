declare global {
  ...
  const prisma: typeof import('../../server/utils/db')['prisma']
...
export { generateToken, verifyToken, getTokenFromHeader, requireAuth, hashPassword, verifyPassword } from '/Users/mac/Desktop/studyProject/DiFlow/server/utils/auth';
